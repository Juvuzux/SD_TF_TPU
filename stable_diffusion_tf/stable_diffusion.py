...
def get_models(img_height, img_width, download_weights=True):
    ...
    text_encoder_weights_fpath = keras.utils.get_file(
        "/kaggle/input/kerasdiffusionmodels/text_encoder.h5",
        origin="",
        #fname="text_encoder.h5",
        #origin="/kaggle/input/kerasdiffusionmodels/text_encoder.h5",
    ...
    diffusion_model_weights_fpath = keras.utils.get_file(
        "/kaggle/input/kerasdiffusionmodels/diffusion_model.h5",
        origin="",
        #fname="diffusion_model.h5",
        #origin="/kaggle/input/kerasdiffusionmodels/diffusion_model.h5",
    ...
    decoder_weights_fpath = keras.utils.get_file(
        "/kaggle/input/kerasdiffusionmodels/decoder.h5",
        origin="",
        #fname="decoder.h5",
        #origin="/kaggle/input/kerasdiffusionmodels/decoder.h5",
